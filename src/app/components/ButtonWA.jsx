...
function ButtonWA() {
  return (
    <Link href={'https://api.whatsapp.com/send?phone=6285602904294&text=halo%20pak%2C%20saya%20mau%20konsultasi%20Plafon.'} className='fixed bottom-12 right-14 z-20'>
